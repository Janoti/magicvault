...
export type Flags = { cardRulings: boolean; setCompletion: boolean; pnl: boolean; events: boolean }
const DEFAULT: Flags = { cardRulings: false, setCompletion: false, pnl: false, events: false }
